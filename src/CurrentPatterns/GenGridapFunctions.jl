...
function generate_gridap_function_dirichlet(vector::Array{Float64,1}, dirichlet_values::Array{Float64,1}, space::Gridap.FESpace.FESpace, N_d, m)
...
function generate_gridap_functions_dirichlet(dict::Dict{Int,Array{Float64,1}}, space::Gridap.FESpace.FESpace, N_d, m)
